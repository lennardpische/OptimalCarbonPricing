...
## Key Findings
* **Carbon Intensity Variance:** Modeled CO2 emissions per seat-km vary significantly across aircraft types (e.g., A321neo vs. older B737 models).
...
* **Model Performance:** The XGBoost regressor successfully captures non-linear relationships between flight capacity, load factors, and market fare.
...
├── images/                          # Exported plots (Histograms, Feature Importance)
